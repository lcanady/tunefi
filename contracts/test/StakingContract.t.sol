...
contract StakingContractTest is Test {
    ...
    uint256 public constant TOTAL_SUPPLY = 10_000 * 10 ** 18; // 10000 tokens for testing
    ...
    function setUp() public {
        ...
        staking = new StakingContract(address(token), MIN_STAKE, REWARD_RATE, SLASH_RATE);
    ...
    function test_StakingSetup() public view {
    ...
    function test_EmergencyState() public {
        ...
        vm.expectRevert("Emergency: staking disabled");
        staking.stake(stakeAmount);
        vm.stopPrank();
    }
    ...
    function test_Slashing() public {
        ...
        // Set bob as slasher
        vm.prank(admin);
        staking.updateSlasher(bob, true);
